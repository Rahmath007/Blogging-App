...
const secret= 'adhasdhsahdhsainsafusaiufaf';
...
mongoose.connect('mongodb+srv://blog:NuISz2RpwKqkydtr@cluster0.99nbzir.mongodb.net/?retryWrites=true&w=majority');
...
app.put('/post', uploadMiddleware.single('file') , async (req, res) => {
    ...
    jwt.verify(token, secret, {}, async (err, info) => {
        ...
        if (!isAuthor) {
            return res.status(400).json('Your are not the author of this post');
        }
